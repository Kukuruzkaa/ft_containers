...
/*   Updated: 2022/08/30 15:30:12 by ddiakova         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	std::std::cout << "Size of JOHN " << JOHN.size() << std::endl;
// 	if (JOHN.capacity() >= JOHN.size())
// 		std::std::cout << "Capacity of JOHN is sufficient\n";
// 	else
// 		std::cerr << "THERE IS A PROBLEM ON LINE 53\n";
// 	std::std::cout << "Size of BOB " << BOB.size() << std::endl;
// 	if (BOB.capacity() >= bob_resize)
// 		std::std::cout << "Capacity of BOB is sufficient\n";
// 	else
// 		std::cerr << "THERE IS A PROBLEM ON LINE 58\n";
// 	std::std::cout << "Size of MIKE " << MIKE.size() << std::endl;
// 	if (MIKE.capacity() >= MIKE.size())
// 		std::std::cout << "Capacity of MIKE is sufficient\n";
// 	else
...
// 	BOB.resize(bob_resize);
// 	std::std::cout << "BOB is empty now ? " << BOB.empty() << '\n';
// 	MIKE.resize(mike_resize, "juste some random std::string");
// 	/*
// 	std::std::cout << "Size of JOHN " << JOHN.size() << std::endl;
// 	std::std::cout << "Capacity of JOHN " << JOHN.capacity() << std::endl;
// 	std::std::cout << "Size of BOB " << BOB.size() << std::endl;
// 	std::std::cout << "Capacity of BOB " << BOB.capacity() << std::endl;
// 	std::std::cout << "Size of MIKE " << MIKE.size() << std::endl;
// 	std::std::cout << "Capacity of MIKE " << MIKE.capacity() << std::endl;
// 	*/
// 	std::std::cout << "Size of JOHN " << JOHN.size() << std::endl;
// 	if (JOHN.capacity() >= JOHN.size())
// 		std::std::cout << "Capacity of JOHN is sufficient\n";
...
// 	// FRONT / BACK
// 	std::std::cout << "\nFRONT / BACK\n";
// 	std::std::cout << "front() of MIKE : " << MIKE.front() << '\n';
// 	std::std::cout << "back() of MIKE : " << MIKE.back() << '\n';
...
// 	std::std::cout << "after push_back, before at\n" << std::endl;
// 	for (size_t i = 0; i < insert_in_me.size(); i++)
// 		std::std::cout << insert_in_me.at(i) << ' ';
// 	std::std::cout << '\n';
// 	std::std::cout << std::endl;
// 	return (0);
// }
...
int main()
{
	...
	insert_in_me.insert(tmp, 1, "Norminet\n");
	std::cout << "After norminet insertion" << std::endl;
	for (size_t i = 0; i < insert_in_me.size(); i++)
		std::cout << insert_in_me.at(i) << ' ';
	std::cout << '\n';
